...
from inputboard import make_clean_board, convert_position_prediction, move_from
...
# tensorboard = TensorBoard(log_dir='/tmp/keras_logs/ChessAI/Conv128x2+1024FCx2_p2')
# filepath = 'Conv128x2+1024FCx2_p2.model'
...
# Y = h5f['moved_to']
# # X_val = h5f['input_position'][7000000:7200000]
# # Y_val = h5f['moved_from'][7000000:7200000]
# # X_val = X_val.reshape(-1, 8, 8, 12)
# num_training_examples = 6000000
# num_val_examples = 1000000
...
model = load_model(r'C:\Users\sayon\OneDrive\Computer Science\Machine Learning\Chess AI\moved_from_model.h5')
